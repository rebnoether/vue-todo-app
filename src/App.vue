...
<template>
  <main class="app">
    <section class="greeting">
      <h2 class="title">
        WHAT'S UP, <input class="title" type="text" id="name" placeholder="Name here" v-model="name">
      </h2>
    </section>
    ...
    <section class="create-todo">
      ...
      <form id="new-todo-form" @submit.prevent="addTodo">
        <input type="text" name="content" id="content" placeholder="Add your Todo" v-model="input_content" />
  ...
  <footer class="footer">
              <!-- <WorldClock /> -->
          <h1 class="big-text">THE DODASH &reg;</h1>
